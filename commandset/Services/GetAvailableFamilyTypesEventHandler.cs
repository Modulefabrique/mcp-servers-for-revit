...
namespace RevitMCPCommandSet.Services
{
    public class GetAvailableFamilyTypesEventHandler : IExternalEventHandler, IWaitableExternalEventHandler
    {
        ...
        // Uitvoeringstijd, iets korter dan de time-out van de aanroep
        ...
        public void Execute(UIApplication app)
        {
            try
            {
                ...
                var familySymbols = new FilteredElementCollector(doc)
                    ...
                    .Cast<FamilySymbol>();
                // Systeemfamilietypen (wanden, vloeren, enz.)
                ...
                // Fuzzy matching op naam (matcht zowel familienaam als typenaam)
                ...
                // Converteer naar een lijst van FamilyTypeInfo
            ...
            {
                TaskDialog.Show("Error", "Ophalen van familietypen mislukt: " + ex.Message);
            }
            finally
            {
                TaskCompleted = true;
